...
import com.harsh.myapplication.api.ApiClient
import com.harsh.myapplication.api.ApiInterface
...
class InfoActivityViewModel(application: Application): AndroidViewModel(application ) {
    ...
    public var albumList: MutableList<Json2KotlinInfoAlbum> = ArrayList<Json2KotlinInfoAlbum>()
...
//                    Log.d("MyTag", "Successful1"+ response.body()?.toString())
                    ...
                    coverImage= response.body()!!.albumInfo!!.image[3].text.toString()
